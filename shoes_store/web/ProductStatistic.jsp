        ...
        <div class="container">
            <div class="table-wrapper">
                ...
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <a href="loadProductAdmin?action=loadProductStatistic" style="text-decoration: none; color: inherit;"><h2>Product <b>Statistic</b></h2></a>
                        </div>

                        <div class="col-sm-4">
                            <div class="col">
                                <form action="search" method="post">
                                    <input type="hidden" name="action" value="searchProductStatistic">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <c:forEach items="${listSoldShoes}" var="o" varStatus="loop">
                            <tr>
                                <td>${loop.index + 1}</td>
                                <td>${o.shoes.productID}</td>
                                <td>${o.shoes.productName}</td>
                                <td>
                                    <img src="${o.shoes.images[0].imageURL}">
                                </td>
                                <td>${o.shoes.category.categoryName}</td>
                                <td>$${o.shoes.productPrice}</td>
                                <td>${o.count}</td>
                            </tr>
                            <c:set var="totalCount" value="${totalCount + o.count}" />
                        </c:forEach>
                        <tr>
                            <td></td>
                            <td></td>
                ...
                <div class="clearfix">
                    <div class="hint-text">Showing <b>${soldShoesCount}</b> entries</div>
                    <ul class="pagination">
                        <%--<c:if test="${index > 1}">
