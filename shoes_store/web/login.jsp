        ...
        <div class="container-fluid border my-4 p-3 bg-white" style="width: 28rem">
            ...
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade" id="pills-login" role="tabpanel" aria-labelledby="pills-login-tab" tabindex="0">
                    ...
                    <hr class="my-2">
                    <div class="d-grid gap-2">
                        <button type="button" class="btn btn-outline-dark rounded-0" style="height: 48px">
                            <a href="https://accounts.google.com/o/oauth2/auth?scope=profile&redirect_uri=http://localhost:8080/StockAndStock/LoginGoogleHandler&response_type=code
		   &client_id=1018151925204-gs8jjbj7j5mdu4296c1r9o4vujia7ov1.apps.googleusercontent.com&approval_prompt=force">Continue with Google</a>
                        </button>
