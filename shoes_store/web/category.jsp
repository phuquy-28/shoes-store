        ...
        <div class="col-3">
            ...
            <div class="col item">
                <div class="d-flex flex-column mb-3 b">
                    <a href="#" class="text-dark fw-semibold">Air Jordan</a>
                    <a href="#" class="text-dark fw-semibold">Adidas</a>
                    <a href="#" class="text-dark fw-semibold">Asics</a>
                    <a href="#" class="text-dark fw-semibold">Converse</a>
                    <a href="#" class="text-dark fw-semibold">New Balance</a>
                    <a href="#" class="text-dark fw-semibold">Nike</a>
                    <a href="#" class="text-dark fw-semibold">Yeezy</a>
                </div>
            </div>
            ...
            <div class="col item">
                <div class="form-check">
                    <input class="form-check-input rounded-0 custom-control-input" type="checkbox" value="" id="under100">
                    <label class="form-check-label" for="under100">
                        Under 100$
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input rounded-0 custom-control-input" type="checkbox" value="" id="100to200">
                    <label class="form-check-label" for="100to200">
                        100$ - 200$
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input rounded-0 custom-control-input" type="checkbox" value="" id="200to300">
                    <label class="form-check-label" for="200to300">
                        200$ - 300$
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input rounded-0 custom-control-input" type="checkbox" value="" id="300to400">
                    <label class="form-check-label" for="300to400">
                        300$ - 400$
                    </label>
                </div>
                <div class="form-check">
                    <input class="form-check-input rounded-0 custom-control-input" type="checkbox" value="" id="400plus">
        ...
        <div class="col-9">
            <div class="row">
                <div class="col p-2">
                    <div class="border border-dark">
                        <div class="col px-2 py-1">
                            <img src="images/Air-Jordan-1-Retro-High-OG-Satin-Bred-Product.webp" alt="alt" class="rounded mx-auto d-block img-fluid p-2">
                        </div>
                        <div class="col px-2 py-1">Jordan 1 Retro High OG Satin Bred</div>
                        <div class="col px-2 py-1 h5">$121</div>
                    </div>
                </div>
                <div class="col p-2">
                    <div class="border border-dark">
                        <div class="col px-2 py-1">
                            <img src="images/Air-Jordan-1-Retro-Low-Golf-Travis-Scott-Neutral-Olive-Product.webp" alt="alt" class="rounded mx-auto d-block img-fluid p-2">
                        </div>
                        <div class="col px-2 py-1">Jordan 1 Retro High OG Satin Bred</div>
                        <div class="col px-2 py-1 h5">$121</div>
                    </div>
                ...
                <div class="col p-2">
                    <div class="border border-dark">
                        <div class="col px-2 py-1">
                            <img src="images/Air-Jordan-12-Retro-Cherry-2023-Product.webp" alt="alt" class="rounded mx-auto d-block img-fluid p-2">
                        </div>
                        <div class="col px-2 py-1">Jordan 1 Retro High OG Satin Bred</div>
                        <div class="col px-2 py-1 h5">$121</div>
                    </div>
                ...
                <div class="col p-2">
                    <div class="border border-dark">
                        <div class="col px-2 py-1">
                            <img src="images/Air-Jordan-4-Retro-Red-Cement-Product.webp" alt="alt" class="rounded mx-auto d-block img-fluid p-2">
                        </div>
                        <div class="col px-2 py-1">Jordan 1 Retro High OG Satin Bred</div>
                        <div class="col px-2 py-1 h5">$121</div>
                    </div>
