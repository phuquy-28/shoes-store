...
//            request.setAttribute("listCategories", listCategories);
        ...
        } else if (action.equals("searchProductStatistic")) {
            String startDate = request.getParameter("start");
            String endDate = request.getParameter("end");
            List<SoldShoes> listSoldShoes = ShoesDB.getSellingShoesCountByInterval(startDate, endDate);
        ...
        } else if (action.equals("searchUserStatistic")){
            String startDate = request.getParameter("start");
            String endDate = request.getParameter("end");
            List<UserSpending> listUserSpending = UserDB.getUserSpendingCountByInterval(startDate, endDate);
            int userSpending = listUserSpending.size();

            request.setAttribute("listUserSpending", listUserSpending);
            request.setAttribute("userSpending", userSpending);
            request.setAttribute("start", startDate);
            request.setAttribute("end", endDate);
